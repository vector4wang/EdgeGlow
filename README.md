...
| 主题 | 色系 | 适用场景 |
|:----:|:----:|:--------:|
| ✨ 虹彩 | 高饱和霓虹紫蓝青粉橙金 | **默认**，模拟 iPhone Apple Intelligence 边缘流光 |
| 🌈 炫酷 | 彩虹全色谱 | 日常使用，视觉冲击最强 |
| 🌊 柔和 | 低饱和蓝紫 | 夜间 / 长时间使用 |
| 🔥 烈焰 | 红橙黄暖色 | 热情满满地写代码 |
| ❄️ 冰雪 | 白蓝冷色 | 冷静思考，专注模式 |

> **✨ 虹彩主题** 模拟 iPhone 上 Apple Intelligence 的 Siri 边缘流光效果：沿屏幕边缘切分为 20 段，每段独立着色（紫→蓝→青→粉→橙→金），相邻段颜色错开，边界处通过高斯模糊自然过渡。四层光效叠加（大光晕 + 中光晕 + 主色线 + 亮芯），呈现出 iPhone 同款的霓虹渐变质感。
